  ...
  return (
    <footer className="border-t border-border bg-card mt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div>
          <h4 className="text-[10px] uppercase tracking-[0.25em] text-muted-foreground mb-4 font-bold">Company</h4>
          <ul className="space-y-3 text-sm">
            <li><Link to="/about"      className="hover:text-hive transition-colors">About Us</Link></li>
            <li><Link to="/faq"        className="hover:text-hive transition-colors">FAQ / Help</Link></li>
